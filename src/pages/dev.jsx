    ...
    return (
      <div>
        <TitleHeader
          title="Control Panel"
          color="black"
          subtitle="ONLY FOR USE BY DEVELOPERS"
        />
        <Root>
          <Container hasHeader>
            <MainCard>
              <CommandoBar>
                <Tabs
                  ...
                  <Tab
                    onClick={() => this.props.history.push("/dev#db")}
                    label="Database"
                    classes={{
                      root: classes.tab,
                      label:
                  ...
                  />
                  <Tab
                    onClick={() => this.props.history.push("/dev#collec")}
                    label="Collections"
                    classes={{
                      root: classes.tab,
                      label:
                  ...
                  />
                  <Tab
                    onClick={() => this.props.history.push("/dev#user")}
                    label="Users"
                    classes={{
                      root: classes.tab,
                      label:
                  ...
                  {profile.role === "admin" ? null : (
                    <Tab
                      onClick={() => this.props.history.push("/dev#feed")}
                      label="Feeds"
                      classes={{
                        root: classes.tab,
                        label:
                  ...
                  <Tab
                    onClick={() => this.props.history.push("/dev#live")}
                    label="Live"
                    classes={{
                      root: classes.tab,
                      label:
