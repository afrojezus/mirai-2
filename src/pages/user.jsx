          ...
          <Container spacing={0}>
            <M.Grid container spacing={0} className={classes.container}>
              ...
              <M.Grid item xs style={{ margin: "auto" }}>
                <M.Typography className={classes.roleTitle} variant="h2">
                  {data ? data.role : user.role}
                </M.Typography>
                <M.Typography className={classes.bigTitle} variant="h2">
                ...
                <M.Typography variant="h4" className={classes.smallTitle}>
