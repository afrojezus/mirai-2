...
import { Column, LoadingIndicator, SectionTitle } from '../components/layouts';
...
export default firebaseConnect()(connect(({ firebase: profile, mir }) => ({ profile, mir }))(M.withStyles(style)(Search)));
