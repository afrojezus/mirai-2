...
class Tag extends Component
{
                      ...
                      this.setState(
                        {
                          ...
                          type: this.props.history.location.search.includes('?s=')
                            ...
                            : this.props.history.location.search.includes('?g=')
                              ? 'GENRE'
                              : 'TAG',
                          title: this.props.history.location.search.includes('?g=')
  ...
  unlike = async () =>
  {
    ...
    {
      this.props.firebase
        .remove(`users/${this.props.profile.userID}/favs/studio/${this.state.id}`)
...
export default firebaseConnect()(connect(({ firebase: { profile } }) => ({ profile }), mapPTS)(M.withStyles(style)(Tag)));
