...
class Setup extends Component
{
  ...
  render()
  {
    ...
    const {
      mode, error, email, password, lang,
    } = this.state;
    return (
...
export default firebaseConnect()(connect(({ firebase: { auth, profile } }) => ({ auth, profile }))(withStyles(styles, { withTheme: true })(Setup)));
