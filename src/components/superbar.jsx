...
const styles = theme => ({
  ...
  mainToolbar: {
    ...
    width: "100%",
    marginRight: "auto",
    paddingRight: isElectron() ? theme.spacing() : null
  },
  gd: {
    width: "100%",
    height: 82,
  ...
  render() {
    ...
    const metaShit = (
      <div className={classes.metashit}>
        <Typography className={classes.footerCopy} variant="h5">
          Mirai 1.0 (2022 semi-fix patch)
          <br />
          {onlineUsers ? Object.values(onlineUsers).length : 0} users online
          <br />
          <br />Developed by Thor "afrojezus"<br />14. March 2018
        </Typography>
        <div className={classes.quicklinks}>
          ...
          <Tooltip title="WIP rework">
            <IconButton
              onClick={() => {
                this.toggleDrawer();
                window.open("https://github.com/tokumei-gr/mirai");
              }}
            >
              <svg style={{ width: 28, height: 28 }} viewBox="0 0 24 24">
                <path
          ...
          <Tooltip title="The original archived repo">
            <IconButton
              onClick={() => {
                this.toggleDrawer();
      ...
      <div className={classes.list}>
        <Hidden mdUp>
          <Toolbar className={classes.drawerToolbar}>
            <Typography variant="h6">Mirai</Typography>
          </Toolbar>
        </Hidden>
        <Hidden mdUp>
          <Divider />
