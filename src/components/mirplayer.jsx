            ...
            ref={(player) =>
{
            ...
            onError={() => this.setState({ error: true, playing: false, status: 'Error occured.' })}
...
export default firebaseConnect()(connect(({ firebase: { profile }, mir }) => ({ profile, mir }), mapPTS)(withStyles(style, { withTheme: true })(MirPlayer)));
