    ...
    _classCallCheck(this, a),
      ...
      (this.resCase =
        'none' === b.resourceCase
          ...
          : 'snake' === b.resourceCase ? snake : kebab),
      (this.plural =
        !1 === b.pluralize
          ? function(a) {
              return a;
                    ...
                    switch ((a.prev = a.next)) {
                      case 0:
                        return (
                          (a.prev = 0),
                          (a.next = 3),
                          serialise.apply(this, [b, c, 'PATCH'])
                        );
                      case 3:
                        return (
                          (d = a.sent),
                    ...
                    switch ((a.prev = a.next)) {
                      case 0:
                        return (
                          ...
                          (a.t1 = d),
                          (a.next = 6),
                          serialise.apply(this, [b, c])
                        );
                      case 6:
                        return (
                          (a.t2 = a.sent),
                          (a.t3 = { headers: Object.assign(this.headers, g) }),
                          (a.next = 10),
                    ...
                    switch ((a.prev = a.next)) {
                      case 0:
                        return (
                          ...
                          (a.t1 = d),
                          (a.next = 6),
                          serialise.apply(this, [b, { id: c }, 'DELETE'])
                        );
                      case 6:
                        return (
                          (a.t2 = a.sent),
